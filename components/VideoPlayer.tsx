    ...
    <div
      ...
      <div
        ...
        <div className="flex-shrink-0 p-2 sm:p-4">
          <button
            onClick={onClose}
            className="absolute top-2 right-2 text-gray-600 hover:text-gray-900 dark:text-white/70 dark:hover:text-white z-10 p-2 rounded-full bg-gray-200/50 hover:bg-gray-300/50 dark:bg-black/20 dark:hover:bg-black/40 transition-colors"
